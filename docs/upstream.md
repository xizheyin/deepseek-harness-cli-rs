...
resident. Attempt payloads, claims, cold-recovery work, and closure headroom are
not charged yet, so the complete shared 32 MiB invariant, pressure trigger,
summary dispatch/checkpoint construction, and Agent-level context-overflow
interception and replay remain later Phase 8 slices.
