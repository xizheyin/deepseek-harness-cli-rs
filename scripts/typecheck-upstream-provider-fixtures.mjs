...
/**
 * Type-check the Phase 2 oracle against the pinned upstream source graph.
 *
...
const oraclePath = join(scriptDir, 'generate-upstream-provider-fixtures.ts')
...
parsed.options.paths = {
  ...parsed.options.paths,
  '@deepseek-ai/dsh-llm-deepseek/src/*': [
...
// The monorepo's packages are normally checked through project references.
// Limit this ad-hoc gate to diagnostics attached to our oracle source itself.
const diagnostics = [
...
if (diagnostics.length > 0) {
  ...
  process.stdout.write('upstream Phase 2 oracle typecheck passed\n')
}
