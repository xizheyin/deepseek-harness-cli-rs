...
/** Type-check the Phase 7 interactive/headless oracle against pinned upstream. */
...
const oraclePath = join(scriptDir, 'generate-upstream-interactive-fixtures.ts')
...
if (diagnostics.length > 0) {
  ...
  process.stdout.write('upstream Phase 7 interactive oracle typecheck passed\n')
}
