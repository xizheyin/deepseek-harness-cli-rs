...
/** Type-check the Phase 3 oracle against the pinned upstream source graph. */
...
const oraclePath = join(scriptDir, 'generate-upstream-agent-fixtures.ts')
...
if (trackedChanges !== '') throw new Error('typecheck requires a clean upstream tracked working tree')
...
if (diagnostics.length > 0) {
  ...
  process.stdout.write('upstream Phase 3 oracle typecheck passed\n')
}
