...
/** Type-check the Phase 4 read-only-tool oracle against the pinned upstream source graph. */
...
const oraclePath = join(scriptDir, 'generate-upstream-tool-fixtures.ts')
...
if (diagnostics.length > 0) {
  ...
  process.stdout.write('upstream Phase 4 tool oracle typecheck passed\n')
}
