...
/** Type-check the Phase 5 file-change/approval oracle against pinned upstream. */
...
const oraclePath = join(scriptDir, 'generate-upstream-file-change-fixtures.ts')
...
if (diagnostics.length > 0) {
  ...
  process.stdout.write('upstream Phase 5 file-change/approval oracle typecheck passed\n')
}
